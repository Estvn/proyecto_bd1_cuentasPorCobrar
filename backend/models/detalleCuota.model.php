...
class DetalleCuotaModel{
    ...
    public function create($tablaDetalleCuota, $datos){
    ...
    public function read($tablaDetalleCuota, $datos){
    ...
    public function update($tablaDetalleCuota, $datos){
    ...
    public function delete($tablaDetalleCuota, $datos){
