...
class FacturaCompraModel{
    ...
    public function create($tablaFacturaCompra, $datos){
    ...
    public function read($tablaFacturaCompra, $datos){
    ...
    public function update($tablaFacturaCompra, $datos){
    ...
    public function delete($tablaFacturaCompra, $datos){
