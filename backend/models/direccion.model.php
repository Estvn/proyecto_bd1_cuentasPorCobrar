...
class DireccionModel{
    ...
    public function create($tablaDireccion, $datos){
    ...
    public function read($tablaDireccion, $datos){
    ...
    public function update($tablaDireccion, $datos){
    ...
    public function delete($tablaDireccion, $datos){
