...
class CategoriaArticuloModel{
    ...
    public function create($tablaCategoriaArticulo, $datos){
    ...
    public function read($tablaCategoriaArticulo, $datos){
    ...
    public function update($tablaCategoriaArticulo, $datos){
    ...
    public function delete($tablaCategoriaArticulo, $datos){
