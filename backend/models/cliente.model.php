...
class ClienteModel{
    ...
    public function create($tablaCliente, $datos){
    ...
    public function read($tablaCliente, $datos){
    ...
    public function update($tablaCliente, $datos){
    ...
    public function delete($tablaCliente, $datos){
