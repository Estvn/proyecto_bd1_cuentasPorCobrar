...
class DeudaModel{
    ...
    public function create($tablaDeuda, $datos){
    ...
    public function read($tablaDeuda, $datos){
    ...
    public function update($tablaDeuda, $datos){
    ...
    public function delete($tablaDeuda, $datos){
