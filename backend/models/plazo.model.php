...
class PlazoModel{
    ...
    public function create($tablaPlazo, $datos){
    ...
    public function read($tablaPlazo, $datos){
    ...
    public function update($tablaPlazo, $datos){
    ...
    public function delete($tablaPlazo, $datos){
