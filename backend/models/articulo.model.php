...
class ArticuloModel{
    ...
    public function create($tablaArticulo, $datos){
    ...
    public function read($tablaArticulo, $datos){
    ...
    public function update($tablaArticulo, $datos){
    ...
    public function delete($tablaArticulo, $datos){
