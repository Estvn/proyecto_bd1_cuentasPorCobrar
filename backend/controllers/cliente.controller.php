...
class ClienteController{
    ...
    public function create($datosCliente){
        ...
        isset($datosCliente["telEmpresa"]) && isset($datosCliente["sueldo"])
            ...
            $clientes = ClienteModel::read("cliente", null);
            ...
            $datos = array(
                "direccionID"=>$datosCliente["direccionID"],
                "generoID"=>$datosCliente["generoID"],
                "antiguedadID"=>$datosCliente["antiguedadID"],
                "pNombre"=>$datosCliente["pNombre"],
                "sNombre"=>$datosCliente["sNombre"],
                "pApellido"=>$datosCliente["pApellido"],
                "sApellido"=>$datosCliente["spellido"],
                "fechaNacimiento"=>$datosCliente["fechaNacimiento"],
                "nIdentidad"=>$datosCliente["nIdentidad"],
                "creditoDisponible"=>$datosCliente["creditoDisponible"],
                "lineaDisponible"=>$datosCliente["lineaDisponible"],
                "nomEmpresa"=>$datosCliente["nomEmpresa"],
                "telEmpresa"=>$datosCliente["telEmpresa"],
                "sueldo"=>$datosCliente["sueldo"]
            );

            // Realizando el llamado del método para la inserción de los datos.
            $create = ClienteModel::create("cliente", $datos);
    ...
    public function readOne($clienteID){
        ...
        $cliente = ClienteModel::read("cliente", $clienteID);
    ...
    public function readAll($nCliente){
    ...
    public function update($datosCliente){
        ...
        $update = ClienteModel::update("cliente", $datos);
