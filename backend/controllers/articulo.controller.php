...
class ArticuloController{
    ...
    public function create($datosArticulo){
        ...
        isset($datosArticulo["cantidadArticulo"])
            ...
            $create = ArticuloModel::create("articulo", $datos);
            ...
            if($create == "ok"){
                ...
                $json=array(
                    "status"=>200,
                    "detalle"=>"El tipo de Articulo se registró exitosamente."
                );
    ...
    public function readOne($articuloID){
        ...
        $articulo = ArticuloModel::read("articulo", $articuloID);
    ...
    public function readAll($nArticulo){

        // Llamando método para hacer la lectura en la tabla de Articulo
        $articulos = ArticuloModel::read("articulo", null);
